...
- **Salt**: 1 chuỗi ngẫu nhiên trộn thêm vào trước khi hash password, để 2 user cùng dùng chung 1 password vẫn ra 2 hash khác nhau (chống tấn công dò bằng bảng hash dựng sẵn, gọi là "rainbow table"). `argon2` tự sinh và tự lưu salt kèm trong chuỗi hash trả về.
