...
Toàn bộ service có business logic (`AuthService`, `TokenService`, `PasswordService`) cần có unit test; toàn bộ flow `/auth/*` cần có e2e test. Đây là yêu cầu bắt buộc theo `../convention/api-conventions.md`, không phải tuỳ chọn.
